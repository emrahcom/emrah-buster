...
lxc-attach -n $MACH -- \
    zsh -c \
    "export DEBIAN_FRONTEND=noninteractive
     mkdir -p /usr/local/eb/share/eb-livestream-origin/source
     cd /usr/local/eb/share/eb-livestream-origin/source
     setopt +o nomatch
...
lxc-attach -n $MACH -- \
    ...
    'cd /usr/local/eb/share/eb-livestream-origin/source
     ...
     cd ..
     mkdir -p /usr/local/eb/deb/eb-livestream-origin
     rm -f /usr/local/eb/deb/eb-livestream-origin/libnginx-*.deb
     rm -f /usr/local/eb/deb/eb-livestream-origin/nginx-*.deb
     mv libnginx-*.deb nginx-*.deb /usr/local/eb/deb/eb-livestream-origin/'
